...
(procedure "call-with-input-file" (arg "filename proc"))
(procedure "call-with-output-file" (arg "filename proc"))
(procedure "input-port?" (arg "obj"))
(procedure "output-port?" (arg "obj"))
(procedure "current-input-port")
(procedure "current-output-port")
(procedure "current-error-port")
(procedure "with-input-from-file" (arg "filename thunk"))
(procedure "with-output-to-file" (arg "filename thunk"))
...
(procedure "write-char" (arg "char textual-output-port"))
(procedure "newline")
(procedure "newline" (arg "textual-output-port"))
(procedure "display" (arg "obj"))
(procedure "display" (arg "obj textual-output-port"))
(procedure "write" (arg "obj"))
(procedure "write" (arg "obj textual-output-port"))
...
(procedure "enum-set-member?" (arg "symbol enum-set"))
...
(procedure "eval" (arg "expression environment"))
...
(procedure "filter" (arg "proc list"))
(procedure "partition" (arg "proc list"))
(procedure "fold-left" (arg "combine nil") (arg "list") (arg "list") (arg "..." rest) (arg "list"))
(procedure "fold-right" (arg "combine nil") (arg "list") (arg "list") (arg "..." rest) (arg "list"))
(procedure "remp" (arg "proc list"))
(procedure "remove" (arg "obj list"))
(procedure "remv" (arg "obj list"))
(procedure "remq" (arg "obj list"))
(procedure "memp" (arg "proc list"))
(procedure "member" (arg "obj list"))
(procedure "memv" (arg "obj list"))
(procedure "memq" (arg "obj list"))
(procedure "assp" (arg "proc alist"))
(procedure "assoc" (arg "obj alist"))
(procedure "assv" (arg "obj alist"))
(procedure "assq" (arg "obj alist"))
...
(procedure "set-car!" (arg "pair obj"))
(procedure "list-sort" (arg "proc list"))
(procedure "vector-sort" (arg "proc vector"))
(procedure "vector-sort!" (arg "proc vector"))
(procedure "string-set!" (arg "string k char"))
(procedure "string-fill!" (arg "string char"))
